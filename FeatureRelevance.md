...
```
## Boruta performed 130 randomForest runs in 2.204 mins.
...
```
## Boruta performed 130 randomForest runs in 30.07 secs.
...
```
## Boruta performed 130 randomForest runs in 3.383 mins.
...
```
## Boruta performed 130 randomForest runs in 4.651 mins.
...
```
## Boruta performed 130 randomForest runs in 5.751 mins.
...
for (i in 2:length(confirmedmass_features)) {
    ...
    masszscore_ttest[i] = t.test(massframe$zscores[is.finite(massframe$zscores)], 
        nonmassframe$zscores[is.finite(nonmassframe$zscores)], alternative = "greater", 
...
pval <- dt[, list(pvalue = paste0("pval: ", format.pval(masszscore_ttest, eps = 1e-04)))]
...
## 1  pval: < 1e-04                 alpha_inside 3.72643460791657
## 2  pval: < 1e-04                 iAUC1_inside 5.49653202325443
## 3  pval: < 1e-04             Slope_ini_inside 7.41995952907895
## 4  pval: < 1e-04                 Tpeak_inside 3.25426170908672
## 5  pval: 0.00094                   SER_inside 5.85918236859728
## 6  pval: < 1e-04                 maxCr_inside 4.12899158899416
## 7  pval: < 1e-04            UptakeRate_inside 5.16074657051028
## 8  pval: < 1e-04           washoutRate_inside 4.82343974491284
## 9  pval: 1.00000            Slope_ini_countor 5.29688867741446
## 10 pval: 1.00000                  SER_countor 4.23199187072562
## 11 pval: < 1e-04                maxCr_countor  4.0054234587162
## 12 pval: < 1e-04           UptakeRate_countor 5.42436538699713
## 13 pval: < 1e-04          washoutRate_countor 5.25431465503698
## 14 pval: < 1e-04                    max_F_r_i 5.41738092319141
## 15 pval: 1.00000                   mean_F_r_i 3.72763216686067
## 16 pval: 0.99926                    var_F_r_i 3.84296983952241
## 17 pval: < 1e-04 iiMin_change_Variance_uptake 5.00746706662652
## 18 pval: < 1e-04                  circularity 5.44714550785231
## 19 pval: < 1e-04                 irregularity 6.62392457188307
## 20 pval: < 1e-04             texture_ASM_zero 4.42023074979814
## 21 pval: < 1e-04       texture_ASM_quarterRad 4.34625980964635
## 22 pval: < 1e-04          texture_ASM_halfRad 4.18560791748292
## 23 pval: < 1e-04      texture_ASM_threeQuaRad 4.38968595751726
## 24 pval: < 1e-04          texture_energy_zero 4.49929827917123
## 25 pval: < 1e-04    texture_energy_quarterRad 4.27763740596377
## 26 pval: < 1e-04       texture_energy_halfRad 4.19645399080177
## 27 pval: < 1e-04   texture_energy_threeQuaRad 4.30967681885716
##    Medz_scoreNonmass
## 1   2.29647635327051
## 2               -Inf
## 3   5.39338750016501
...
## 1  pval: 1.00000                  Slope_ini_inside  5.39338750016501
## 2  pval: 0.99906                        SER_inside  5.62377402227592
## 3  pval: < 1e-04                     peakCr_inside   3.4969086461104
## 4  pval: 1.00000                 UptakeRate_inside   4.0837633182279
## 5  pval: 1.00000                washoutRate_inside  3.40697029254541
## 6  pval: < 1e-04                     alpha_countor  5.80303637208856
## 7  pval: < 1e-04                 Slope_ini_countor  6.28165293861431
## 8  pval: < 1e-04                       SER_countor  6.50576239656254
## 9  pval: 1.00000                         max_F_r_i  4.68435757977446
## 10 pval: < 1e-04                        mean_F_r_i  4.46051599608606
## 11 pval: 0.00074                         var_F_r_i   4.2485697296019
## 12 pval: < 1e-04            iiiMax_Margin_Gradient  6.08490013970087
## 13 pval: < 1e-04                        ivVariance  4.28443583006683
## 14 pval: < 1e-04                    edge_sharp_std  4.16420379668512
## 15 pval: < 1e-04          texture_contrast_halfRad  3.82786421912304
## 16 pval: < 1e-04      texture_contrast_threeQuaRad  3.78731132298919
## 17 pval: < 1e-04 texture_dissimilarity_threeQuaRad  3.72648168226528
##       Medz_scoreMass
## 1   7.41995952907895
## 2   5.85918236859728
## 3   3.03978972098254
